...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](https://pkg.go.dev/github.com/qtumproject/btcd/integration/rpctest)
...
```bash
$ go get -u github.com/qtumproject/btcd/integration/rpctest
```
