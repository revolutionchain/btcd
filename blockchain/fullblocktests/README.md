...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](https://pkg.go.dev/github.com/revolutionchain/btcd/blockchain/fullblocktests)
...
```bash
$ go get -u github.com/revolutionchain/btcd/blockchain/fullblocktests
```
