...
[![GoDoc](http://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/alejoacosta74/btcd/btcutil/txsort)
...
```bash
$ go get -u github.com/alejoacosta74/btcd/btcutil/txsort
```
