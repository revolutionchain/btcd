...
[![GoDoc](http://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/revolutionchain/btcd/btcutil/txsort)
...
```bash
$ go get -u github.com/revolutionchain/btcd/btcutil/txsort
```
