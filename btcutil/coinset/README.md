...
[![GoDoc](http://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/qtumproject/btcd/btcutil/coinset)
...
```bash
$ go get -u github.com/qtumproject/btcd/btcutil/coinset
```
