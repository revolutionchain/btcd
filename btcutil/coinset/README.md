...
[![GoDoc](http://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/revolutionchain/btcd/btcutil/coinset)
...
```bash
$ go get -u github.com/revolutionchain/btcd/btcutil/coinset
```
