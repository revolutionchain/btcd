...
* Install the MSI available at: [btcd windows installer](https://github.com/alejoacosta74/btcd/releases)
...
```bash
git clone https://github.com/alejoacosta74/btcd $GOPATH/src/github.com/alejoacosta74/btcd
...
* [Using bootstrap.dat](https://github.com/alejoacosta74/btcd/blob/master/docs/configuration.md#using-bootstrapdat)
