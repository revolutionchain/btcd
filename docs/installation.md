...
* Install the MSI available at: [btcd windows installer](https://github.com/revolutionchain/btcd/releases)
...
```bash
git clone https://github.com/revolutionchain/btcd $GOPATH/src/github.com/revolutionchain/btcd
...
* [Using bootstrap.dat](https://github.com/revolutionchain/btcd/blob/master/docs/configuration.md#using-bootstrapdat)
