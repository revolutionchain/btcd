...
* Install the MSI available at: [btcd windows installer](https://github.com/qtumproject/btcd/releases)
...
```bash
git clone https://github.com/qtumproject/btcd $GOPATH/src/github.com/qtumproject/btcd
...
* [Using bootstrap.dat](https://github.com/qtumproject/btcd/blob/master/docs/configuration.md#using-bootstrapdat)
