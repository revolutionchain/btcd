...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](https://pkg.go.dev/github.com/qtumproject/btcd/peer)
...
```bash
$ go get -u github.com/qtumproject/btcd/peer
```

## Examples

* [New Outbound Peer Example](https://pkg.go.dev/github.com/qtumproject/btcd/peer#example-package--NewOutboundPeer)  
