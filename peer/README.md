...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](https://pkg.go.dev/github.com/alejoacosta74/btcd/peer)
...
```bash
$ go get -u github.com/alejoacosta74/btcd/peer
```

## Examples

* [New Outbound Peer Example](https://pkg.go.dev/github.com/alejoacosta74/btcd/peer#example-package--NewOutboundPeer)  
