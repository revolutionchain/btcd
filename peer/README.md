...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](https://pkg.go.dev/github.com/revolutionchain/btcd/peer)
...
```bash
$ go get -u github.com/revolutionchain/btcd/peer
```

## Examples

* [New Outbound Peer Example](https://pkg.go.dev/github.com/revolutionchain/btcd/peer#example-package--NewOutboundPeer)  
