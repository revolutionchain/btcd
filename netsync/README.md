...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](https://pkg.go.dev/github.com/alejoacosta74/btcd/netsync)
...
```bash
$ go get -u github.com/alejoacosta74/btcd/netsync
```
